...
function FietsverzekeringMain() {
  return (
    <div className="p-4 w-full h-[65vh] md:h-[75vh]">
      <div className="relative w-full h-full">
        {/* Background Image and Overlay remain the same */}
        <Image
          src="/img/young-woman-riding-bike-city.jpg"
          fill
          alt="Moderne vrouw fietst op een e-bike door een zonnige, groene stad"
          ...
          <div className="text-center md:text-left">
            <h1 className="text-3xl font-bold leading-tight mt-10 text-white sm:text-4xl md:text-5xl lg:text-6xl">
              ...
              <p className="mt-2 text-2xl font-normal md:text-4xl">
                Voor uw E-bike en stadsfiets.
              </p>
            </h1>

            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Uw fiets is een kostbaar bezit. Verzeker hem tegen diefstal en
              schade, <br />
              en ga met een gerust hart op pad.
            </p>
...
export default FietsverzekeringMain;
