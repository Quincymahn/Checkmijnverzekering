    ...
    <div className="px-4 mt-20 mb-30">
      <div className="mx-auto mb-12 text-center">
        ...
        <p className="max-w-md mx-auto text-gray-600">
          Of u nu een weekendje weg gaat of een wereldreis plant, onverwachte
          gebeurtenissen kunnen uw reisplannen flink in de war schoppen.
        </p>
      </div>
      ...
      <div className="relative grid items-center justify-center max-w-5xl grid-cols-1 gap-6 mx-auto md:grid-cols-3">
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          ...
          />
          <p className="mb-5 text-xl font-semibold">Medische Kosten</p>
          <p className="mb-5 text-gray-600">
            Dekt spoedeisende medische hulp in het buitenland die uw eigen
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            ...
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Bagage & Eigendommen</p>
          <p className="mb-5 text-gray-600">
            Verzekerd tegen diefstal, verlies of beschadiging van uw koffer,
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            ...
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Annulering</p>
          <p className="mb-5 text-gray-600">
            Krijg uw reissom terug als u uw vakantie onverwacht moet annuleren
...
export default ReisverzekeringCards;
