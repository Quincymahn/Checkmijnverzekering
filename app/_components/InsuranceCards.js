...
function InsuranceCard({ icon, title, description, href }) {
  return (
    <div className="flex flex-col items-center justify-center h-full p-5 border border-white bg-white/50 rounded-2xl backdrop-blur-md shadow-md-custom">
      <Image src={icon} width={130} height={130} alt={`${title} icoon`} />
      <p className="my-4 text-xl font-semibold">{title}</p>
      <p className="flex-grow mb-5 text-center text-gray-600">{description}</p>
      <Link
        href={href}
...
function InsuranceCards() {
  const insuranceData = [
    {
      icon: "/img/Generated-Image-September-11-2025-10_13AM.png", // Vervang door uw icoon
      title: "Wonen",
      description:
    ...
    {
      icon: "/img/Generated-Image-September-11-2025-10_11AM.png", // Vervang door uw icoon
      title: "Verkeer",
      description:
    ...
    {
      icon: "/img/Generated-Image-September-12-2025-2_44PM.png", // Vervang door uw icoon
    ...
    {
      icon: "/img/Generated-Image-September-24-2025-10_33AM.png", // Vervang door uw icoon
    ...
    {
      icon: "/img/Generated-Image-September-11-2025-10_14AM.png", // Vervang door uw icoon
  ...
  return (
    <div className="relative grid min-[1150px]:grid-cols-5 min-[770px]:grid-cols-3 min-[550px]:grid-cols-2 grid-cols-1 gap-6 my-30">
      <div className="absolute bg-[#00af76] rounded-full w-40 h-40 -bottom-10 -left-10 -z-10"></div>
      ...
      <div className="absolute pointer-events-none -top-10 -right-10 w-23 h-23 -z-10">
        <svg
          viewBox="0 0 100 100"
