          ...
          <div className="text-center md:text-left">
            <h1 className="mt-10 text-3xl font-bold leading-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
              ...
              <span className="block mt-2 text-2xl font-normal sm:text-3xl md:text-4xl">
                Voor een helder en zeker gevoel.
              </span>
            </h1>

            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Een sterretje of een barst in een ruit is zo gebeurd. Met de
              glasverzekering <br className="hidden md:block" />
              wordt ruitschade snel en vakkundig hersteld, zonder onverwachte
              kosten.
            </p>
...
export default GlasverzekeringMain;
