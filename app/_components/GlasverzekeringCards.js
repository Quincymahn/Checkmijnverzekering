...
function GlasverzekeringCards() {
  return (
    <div className="px-4 mt-20 mb-30">
      <div className="mx-auto mb-12 text-center">
        <p className="mb-4 text-3xl font-medium ">
          Waarom Glas Apart Verzekeren?
        </p>
        <p className="max-w-md mx-auto text-gray-600">
          Hoewel vaak onderdeel van een woonverzekering, biedt een specifieke
          glasverzekering zekerheid en gemak bij een van de meest voorkomende
          schades.
        </p>
      </div>
      ...
      <div className="relative grid items-center justify-center max-w-5xl grid-cols-1 gap-6 mx-auto md:grid-cols-3">
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          ...
          />
          <p className="mb-5 text-xl font-semibold">Alle Soorten Glas</p>
          <p className="mb-5 text-gray-600">
            Niet alleen de ruiten in uw deuren en ramen zijn gedekt, maar vaak
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            ...
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Snelle herstelservice</p>
          <p className="mb-5 text-gray-600">
            Eén telefoontje is genoeg. Wij schakelen direct een professionele
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            ...
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Vaak Geen Eigen Risico</p>
          <p className="mb-5 text-gray-600">
            Bij de meeste glasverzekeringen betaalt u geen eigen risico. De
...
export default GlasverzekeringCards;
