...
function OldtimerverzekeringCards() {
  return (
    <div className="px-4 mt-20 mb-30">
      <div className="mx-auto mb-12 text-center">
        <p className="mb-4 text-3xl font-medium ">Hoe werkt het? </p>
        <p className="max-w-md mx-auto text-gray-600">
          Het verzekeren van een klassieker vraagt om een speciale aanpak. Wij
          maken het eenvoudig en transparant.
        </p>
      </div>
      ...
      <div className="relative grid items-center justify-center max-w-5xl grid-cols-1 gap-6 mx-auto md:grid-cols-3">
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            src="/img/oldtimer-main-car.png" // <-- Nieuw relevant icoon
            width={60}
            height={60}
            alt="Klassieke auto icoon"
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Vul uw gegevens in</p>
          <p className="mb-5 text-gray-600">
            Geef het kenteken van uw klassieker, de taxatiewaarde en uw gegevens
            op. Dit is de basis voor een premie op maat.
          </p>
          <Link
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            ...
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Vergelijk op maat</p>
          <p className="mb-5 text-gray-600">
            We tonen de speciale oldtimerdekkingen (WA, Beperkt Casco,
            Casco/Allrisk) die uitgaan van de taxatiewaarde.
          </p>
          <Link
            href="/plan-een-gesprek"
            className="text-[#1b7ced] hover:text-blue-800 transition-all duration-300 group mt-auto"
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            ...
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Kies & geniet</p>
          <p className="mb-5 text-gray-600">
            De juiste polis gevonden? Wij regelen de aanvraag zodat u met een
            gerust hart van uw oldtimer kunt genieten.
          </p>
          <Link
            href="/plan-een-gesprek"
            className="text-[#1b7ced] hover:text-blue-800 transition-all duration-300 group mt-auto"
...
export default OldtimerverzekeringCards;
