...
function OpstalverzekeringMain() {
  return (
    <div className="p-4 w-full h-[65vh] md:h-[75vh]">
      <div className="relative w-full h-full">
        {/* Background Image and Overlay remain the same */}
        <Image
          src="/img/old-buildings-gardens-nesebar-bulgaria.jpg"
          fill
          alt="Mooi vrijstaand huis met een verzorgde tuin"
        ...
        >
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Vergelijk de beste woonhuisverzekeringen en zorg ervoor dat uw
              thuis <br className="hidden md:block" />
              perfect verzekerd is tegen brand, storm en andere onverwachte
              schade.
            </p>
...
export default OpstalverzekeringMain;
