...
function CaravanverzekeringMain() {
  return (
    <div className="p-4 w-full h-[65vh] md:h-[75vh]">
      <div className="relative w-full h-full">
        {/* Background Image and Overlay remain the same */}
        <Image
          src="/img/group-friends-enjoying-their-time-together-mountains-friends-camping-retro-camper-van-background.jpg"
          fill
          alt="Caravan staat op een camping aan een meer met bergen op de achtergrond"
          ...
          <div className="text-center md:text-left">
            <h1 className="mt-10 text-3xl font-bold leading-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
              ...
              <p className="mt-2 text-2xl font-normal md:text-4xl">
                Voor onbezorgd kampeerplezier.
              </p>
            </h1>

            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Uw stacaravan of toercaravan is uw tweede thuis. Zorg voor een{" "}
              <br />
              complete verzekering tegen diefstal, storm, hagel en andere
              schades.
            </p>
...
export default CaravanverzekeringMain;
