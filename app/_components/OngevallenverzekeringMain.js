          ...
          <div className="text-center md:text-left">
            <h1 className="text-3xl font-bold leading-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
              ...
              <p className="mt-2 text-2xl font-normal md:text-4xl">
                Een financieel vangnet, 24/7.
              </p>
            </h1>

            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Een ongeluk kan uw leven veranderen. Deze verzekering keert
              eenmalig <br />
              een bedrag uit bij blijvende invaliditeit of overlijden na een
              ongeval.
            </p>
...
export default OngevallenverzekeringMain;
