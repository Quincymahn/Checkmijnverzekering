        ...
        >
          ...
          <div className="text-center md:text-left">
            <h1 className="text-3xl font-bold leading-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
              Autoverzekering vergelijken <p>snel, onafhankelijk en helder.</p>
            </h1>

            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Vergelijk premies en dekkingen van meerdere verzekeraars en kies
              de <br />
              polis die past bij jouw situatie. Start vandaag nog.
            </p>
...
export default AutoverzekeringMain;
