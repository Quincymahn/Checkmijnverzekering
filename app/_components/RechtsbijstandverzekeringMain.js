...
function RechtsbijstandverzekeringMain() {
  return (
    <div className="p-4 w-full h-[65vh] md:h-[75vh]">
      <div className="relative w-full h-full">
        {/* Background Image and Overlay remain the same */}
        <Image
          src="/img/member-human-resource-team-talking-with-candidate-while-reviewing-his-resume-job-interview-office.jpg"
          fill
        ...
        >
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Een conflict met uw werkgever, buren of in het verkeer? Met een
              rechtsbijstand- <br />
              verzekering krijgt u juridische hulp zonder onverwacht hoge
              advocaatkosten.
            </p>
...
export default RechtsbijstandverzekeringMain;
