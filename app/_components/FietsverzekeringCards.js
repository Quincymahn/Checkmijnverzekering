...
function FietsverzekeringCards() {
  return (
    <div className="px-4 mt-20 mb-30">
      <div className="mx-auto mb-12 text-center">
        <p className="mb-4 text-3xl font-medium ">
          Waarom uw Fiets Verzekeren?{" "}
        </p>
        <p className="max-w-md mx-auto text-gray-600">
          Een goede fietsverzekering is onmisbaar geworden, zeker met de hoge
          waarde van e-bikes en het toenemende diefstalrisico.
        </p>
      </div>
      ...
      <div className="relative grid items-center justify-center max-w-5xl grid-cols-1 gap-6 mx-auto md:grid-cols-3">
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          ...
          />
          <p className="mb-5 text-xl font-semibold">Diefstaldekking</p>
          <p className="mb-5 text-gray-600">
            Wordt uw fiets gestolen? Dan krijgt u de eerste 3 jaar vaak de
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            ...
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Schade (Casco)</p>
          <p className="mb-5 text-gray-600">
            Ook schade aan uw fiets door een val, aanrijding of vandalisme is
        ...
        <div className="flex flex-col items-center h-full px-6 py-5 text-center border border-white rounded-2xl backdrop-blur-md bg-gray-400/20 shadow-md-custom">
          <Image
            ...
            className="w-20 h-20 mb-4"
          />
          <p className="mb-5 text-xl font-semibold">Pechhulp Onderweg</p>
          <p className="mb-5 text-gray-600">
            Met een lekke band of lege accu langs de weg? Met de pechhulp-module
...
export default FietsverzekeringCards;
