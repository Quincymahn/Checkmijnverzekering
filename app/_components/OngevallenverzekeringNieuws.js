...
function OngevallenverzekeringNieuws({ posts }) {
  const woonPosts = posts
    .filter((post) => post.category === "Recht & Zekerheid")
    .slice(0, 3);
    ...
    <div className="px-4 mx-auto max-w-7xl py-30">
      <div className="flex gap-4">
        <p className="text-3xl font-medium">
          Laatste nieuws over Recht & Zekerheid
        </p>
...
export default OngevallenverzekeringNieuws;
