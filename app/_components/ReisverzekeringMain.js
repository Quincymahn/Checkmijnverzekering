        ...
        >
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Ga met een onbezorgd gevoel op reis. Vergelijk de beste
              verzekeringen <br />
              en dek u in tegen onverwachte gebeurtenissen, voor en tijdens uw
              vakantie.
            </p>
...
export default ReisverzekeringMain;
