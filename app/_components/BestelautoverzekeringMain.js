...
function BestelautoverzekeringMain() {
  return (
    <div className="p-4 w-full h-[65vh] md:h-[75vh]">
      <div className="relative w-full h-full">
        {/* Background Image and Overlay remain the same */}
        <Image
          src="/img/man-loading-packages.jpg"
          fill
          alt="Man laadt dozen in een witte bestelbus"
        ...
        >
          ...
          <div className="text-center md:text-left">
            <h1 className="text-3xl font-bold leading-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
              Bestelautoverzekering <br /> Vergelijken
            </h1>

            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Of u uw bestelauto nu zakelijk of particulier gebruikt, <br />
              een goede verzekering is essentieel. Vergelijk en vind de beste
              deal.
            </p>
...
export default BestelautoverzekeringMain;
