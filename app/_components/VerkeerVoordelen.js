...
function VerkeerVoordelen() {
  const voordelenData = [
    {
      icon: <Percent size={32} className="text-blue-500" />,
      title: "Aantrekkelijke Pakketkorting",
      description:
        "Heeft u meerdere voertuigen, of combineert u uw autoverzekering met een rechtsbijstandpolis? Dan profiteert u vaak van een aanzienlijke korting op uw totale premie.",
    },
    {
    ...
    },
    {
      ...
      title: "No-Claimkorting Beschermen",
      description:
        "Wij zoeken naar polissen met een goede no-claimbeschermer. Zo kunt u soms een schade claimen zonder direct uw opgebouwde korting en schadevrije jaren te verliezen.",
    },
    {
      icon: <UserCheck size={32} className="text-blue-500" />,
      title: "Hulp bij Schadeafhandeling",
      description:
        "Bij een aanrijding staat u er niet alleen voor. Wij zijn uw persoonlijke belangenbehartiger en helpen u van de melding tot en met de uitkering door de verzekeraar.",
    },
  ];
      ...
      <div className="px-4 mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          <h2 className="text-3xl font-medium text-gray-800">
            Slim Combineren: De Voordelen van een Verkeerspakket
          </h2>
...
export default VerkeerVoordelen;
