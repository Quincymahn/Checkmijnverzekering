...
function CaravanverzekeringNieuws({ posts }) {
  const woonPosts = posts
    .filter((post) => post.category === "Vrije Tijd")
    .slice(0, 3);

  return (
    <div className="px-4 mx-auto max-w-7xl py-30">
      <div className="flex gap-4">
        <p className="text-3xl font-medium">Laatste nieuws & kampeertips</p>
...
export default CaravanverzekeringNieuws;
