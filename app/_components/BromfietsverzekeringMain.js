        ...
        >
          ...
          <div className="text-center md:text-left">
            <h1 className="text-3xl font-bold leading-tight mt-10 text-white sm:text-4xl md:text-5xl lg:text-6xl">
              Bromfiets & Scooter <br /> verzekering vergelijken
            </h1>

            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Of je nu een snorfiets, brommer of scooter hebt, wij vinden de{" "}
              <br />
              beste en goedkoopste verzekering voor jou.
            </p>
...
export default BromfietsverzekeringMain;
