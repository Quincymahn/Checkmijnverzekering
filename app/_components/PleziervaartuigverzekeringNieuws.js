...
function PleziervaartuigverzekeringNieuws({ posts }) {
  ...
  return (
    <div className="px-4 mx-auto max-w-7xl py-30">
      <div className="flex gap-4">
        <p className="text-3xl font-medium">Laatste nieuws & vaartips</p>
...
export default PleziervaartuigverzekeringNieuws;
