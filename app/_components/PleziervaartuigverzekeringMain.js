...
function PleziervaartuigverzekeringMain() {
  return (
    <div className="p-4 w-full h-[65vh] md:h-[75vh]">
      <div className="relative w-full h-full">
        {/* Background Image and Overlay remain the same */}
        <Image
          src="/img/rear-view-family-boat-wooden-fences.jpg"
          fill
          alt="Luxe sloep vaart over een rustig meer tijdens zonsondergang"
        ...
        >
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-6 mb-10 text-base italic text-gray-100 md:text-lg">
              Of u nu een sloep, zeilboot of motorjacht heeft, uw passie
              verdient <br />
              de beste verzekering. Vind de dekking die bij uw boot en
              vaargebied past.
            </p>
...
export default PleziervaartuigverzekeringMain;
